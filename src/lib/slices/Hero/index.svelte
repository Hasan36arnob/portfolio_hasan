<script lang="ts">
	...
	const first_name_letters = cv_data.name.first.split('');
	const last_name_letters = cv_data.name.last.split('');
	...
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<div class="col-start-1 md:row-start-1">
				<h1
					class="mb-2 md:mb-8 text-[clamp(3rem,20vmin,13rem)] font-extrabold leading-none tracking-normal text-nowrap"
					aria-label={cv_data.name.first + ' ' + cv_data.name.last}
				>
